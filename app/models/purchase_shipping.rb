class PurchaseShipping
  ...
  def save
    ...
    ShippingAddress.create(postal_code: postal_code, prefecture_id: prefecture_id, address: address,
                           address_number: address_number, building_name: building_name, phone_number: phone_number, purchase_id: purchase.id)
  end
end
